...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FYI: linkaxes([ax1 ax2 ax3],'xy') % this command often causes matlab to crash.
% Works on Rat 445, 439,425.
% clearvars
close all
OUT = [];
...
load('Events.mat','EVT')
% The following addresses some ideosyncracies on how data was stored/named
...
% recording block).
%%%%%%%%%%%%%%%%%
WCCV_SHIFT_ASSUMPTION_SEC = 5.01; % I would assume time 0 is when recording started - but this is NOT the case. This shift accounts for the arbitrary time 0 from WCCV
good_npxl_scan_times_sec = Restrict(all_scan_times,block_se-WCCV_SHIFT_ASSUMPTION_SEC);
% block_start_time_sec = EVT.block_time.time_sec(:) - WCCV_SHIFT_ASSUMPTION_SEC; % again, stupid that you have to subtract 5. Makes no sense.
...
NPXL_block_start_sec = TI.start_times_sec - WCCV_SHIFT_ASSUMPTION_SEC; % yeah - dumb.
