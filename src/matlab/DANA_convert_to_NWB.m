...
% interface.
% Now, a year later, there seems to be a NeuroConv project that may
% streamline this process. Python seems to be first language of choice here
% so we may have to bite the bullet and stick to python for this stage- not
% a big deal perhaps. We can add this to the server 
%
