...
%        4) Copy this demo and all the files in this directory to that directory, but put your name at the end of the this file name.
...
[pc,sc,lat] = pca(zscore(Qsmallbin)); 
figure
